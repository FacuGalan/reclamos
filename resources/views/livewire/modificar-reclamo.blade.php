<div class="mx-auto p-0">
    ...
    <div class="flex justify-between items-center pt-6 dark:border-gray-600" >
            <button 
            ...
            <button 
                wire:click="save"
                class="px-8 py-2 bg-[#77BF43] text-white rounded-lg hover:bg-[#5a9032] transition-colors flex items-center font-medium">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
