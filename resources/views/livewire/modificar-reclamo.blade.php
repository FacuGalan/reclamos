        ...
        <div class="grid lg:grid-cols-2 gap-8">
            <div>
                    ...
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-700 dark:text-blue-300 mt-1">
                                Este reclamo se cargó sin datos del denunciante.
                            </p>
                        </div>
                    </div>
                @else
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div x-data="{ tel: @js($persona_telefono ?? ''), digits() { return String(this.tel || '').replace(/\D/g,''); } }">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Teléfono *
                        </label>
                        <div class="flex gap-2 items-stretch">
                            <input
                                ...
                                x-on:input="tel = $event.target.value"
                                class="flex-1 min-w-0 bg-white px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#77BF43] focus:border-[#77BF43] dark:bg-gray-700 dark:text-white"
                                placeholder="Ingrese el teléfono">
                            <a
                                x-bind:href="digits().length > 0 ? 'https://wa.me/549' + digits() : '#'"
                                x-bind:style="digits().length > 0 ? 'background-color:#25D366' : 'background-color:#9ca3af;pointer-events:none;opacity:0.6'"
                                target="_blank"
                                rel="noopener noreferrer"
                                title="Abrir conversación de WhatsApp"
                                class="flex-shrink-0 inline-flex items-center justify-center px-3 text-white rounded-lg transition-colors hover:opacity-90"
                                style="background-color:#25D366;min-width:44px;">
