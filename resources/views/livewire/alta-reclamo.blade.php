        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            @elseif ($step == 2 )
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Adjuntar imagen <span class="text-gray-400 font-normal">(opcional)</span>
                        </label>
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 transition-colors">
                                @if ($imagen)
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            <span class="font-semibold text-green-600">Imagen cargada</span>
                                        </p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $imagen->getClientOriginalName() }}</p>
                                        <p class="text-xs text-blue-500 mt-1">Click para cambiar</p>
                                    </div>
                                @else
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            <span class="font-semibold">Click para subir</span> o arrastre una imagen
                                        </p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG o GIF (máx. 5MB)</p>
                                    </div>
                                @endif
                        ...
                        @if ($imagen)
                            <div class="mt-3 relative inline-block">
                                <img src="{{ $imagen->temporaryUrl() }}" class="h-32 w-auto rounded-lg shadow-md">
                                <button
                                    type="button"
