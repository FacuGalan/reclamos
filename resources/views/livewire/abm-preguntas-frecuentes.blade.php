<div class="max-w-7xl mx-auto p-6 pt-0 space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Preguntas Frecuentes</h1>
            <p class="text-gray-600 dark:text-gray-300">Administra las preguntas y respuestas frecuentes</p>
        </div>
        
        <button 
            wire:click="nuevaPregunta"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    <button 
                                        wire:click="confirmarEliminacion({{ $pregunta->id }})"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-gray-500 dark:text-gray-400">
                                    <p class="text-lg font-medium">No se encontraron preguntas</p>
                                    <p class="text-sm">Intenta ajustar los filtros o crear una nueva pregunta.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#77BF43] focus:border-[#77BF43] dark:bg-gray-700 dark:text-white
                                @error('pregunta') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
                            placeholder="Ingrese la pregunta"
                            autofocus>
                        @error('pregunta') 
                            <div class="mt-2 p-2 bg-red-50 border border-red-200 rounded-md text-red-600 text-sm">
                                {{ $message }}
                            </div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#77BF43] focus:border-[#77BF43] dark:bg-gray-700 dark:text-white
                                @error('respuesta') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
                ...
                <div class="flex items-start mb-4">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            ¿Estás seguro de que deseas eliminar la pregunta "{{ $selectedPregunta?->pregunta }}"? Esta acción no se puede deshacer.
                        </p>
                        @if($selectedPregunta)
                            <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                                <p><strong>Área:</strong> {{ $selectedPregunta->area->nombre }}</p>
                            </div>
                        @endif
                    </div>
                </div>
