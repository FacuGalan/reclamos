<div class="container mx-auto py-12">
    <div class="flex flex-col lg:flex-row gap-8 justify-center items-stretch max-w-6xl mx-auto">
        {{-- Tarjeta 1: Reclamos --}}
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-zinc-700 flex-1 max-w-sm mx-auto lg:mx-0 flex flex-col">
